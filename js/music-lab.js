(() => {
  ...
  const tracks = {
    ...
    woodland: {
      ...
      waveform: 'triangle',
      melody: [
        67, 70, 74, 72, 70, 69, 67, null,
        62, 65, 69, 67, 65, 63, 62, null,
        67, 70, 74, 75, 74, 70, 67, null,
        67, 71, 74, 72, 71, 69, 67, null,
        62, 66, 69, 67, 66, 64, 62, null,
        67, 71, 74, 76, 74, 71, 67, null
      ],
      bass: [43, 50, 46, 41, 43, 50, 43, 50, 47, 42, 43, 50],
      chords: [
        [55, 58, 62], [58, 62, 65], [55, 58, 62],
        [55, 59, 62], [59, 62, 66], [55, 59, 62]
      ]
    },
    reply: {
      title: '舞步的回信',
      ...
      waveform: 'sine',
      melody: [
        67, 69, 71, null, 74, 72, 71, 69,
        67, null, 62, 64, 66, 69, 67, null,
        67, 69, 71, 72, 74, 72, 71, 69,
        67, 66, 62, 64, 66, 69, 67, 69,
        67, 69, 71, null, 74, 72, 71, 69,
        67, null, 62, 64, 66, 69, 67, null
      ],
      bass: [43, 50, 38, 45, 43, 50, 38, 45, 43, 50, 38, 43],
      chords: [
        [55, 59, 62], [50, 54, 57], [55, 59, 62],
        [50, 54, 57], [55, 59, 62], [50, 54, 57]
      ]
    },
    threeNotes: {
      title: '湖面三音',
      ...
      waveform: 'triangle',
      melody: [
        62, 65, 64, null, 62, 65, 64, null,
        57, 60, 59, null, 62, 65, 64, null,
        69, 72, 71, 69, 67, 65, 64, null,
        62, 65, 64, 62, 60, 59, 57, null,
        62, 65, 64, 67, 65, 64, 62, null,
        57, 60, 59, 62, 60, 59, 62, null
      ],
      bass: [38, 45, 41, 48, 38, 45, 41, 48, 38, 43, 45, 38],
      chords: [
        [50, 54, 57], [53, 57, 60], [50, 55, 59],
        [50, 54, 57], [48, 52, 55], [50, 54, 57]
      ]
    },
    brightening: {
      title: '远景渐明',
      ...
      waveform: 'sine',
      melody: [
        62, 64, 66, 69, 67, 66, 64, null,
        62, 66, 69, 71, 69, 67, 66, null,
        64, 66, 69, 73, 71, 69, 67, 66,
        64, 67, 71, 74, 73, 71, 69, null,
        66, 69, 73, 76, 74, 73, 71, 69,
        67, 71, 74, 78, 76, 74, 73, null,
        69, 73, 76, 78, 76, 73, 71, 69,
        66, 69, 73, 76, 74, 71, 69, 66
      ],
      bass: [38, 45, 43, 50, 42, 49, 45, 52, 47, 54, 50, 57, 42, 49, 45, 50],
      chords: [
        [50, 54, 57], [55, 59, 62], [54, 57, 61], [57, 61, 64],
        [59, 62, 66], [54, 57, 61], [57, 61, 64], [50, 54, 57]
      ]
    },
    harbor: {
      title: '归港',
